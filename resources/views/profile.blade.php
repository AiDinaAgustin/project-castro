...
<main class="w-full flex flex-col items-center gap-3 min-h-screen overflow-x-hidden">
    ...
    <!-- Modal toggle -->
    <button class="block text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="default-modal">
      Ubah Profile
      </button>
