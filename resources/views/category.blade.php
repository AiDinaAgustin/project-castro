...
@section('content')
    ...
    <!-- Acaramu -->
    <div class="mb-4">
        <h3 class="text-2xl text-white font-bold mb-4">{{ $category }} Tranding</h3>
                ...
                <a href="/podcasts/{{ $podcast->slug }}">
                  <div class="cover-music bg-zinc-800 w-40 h-56 rounded-md p-2">
                    <div class="relative w-36">
                      <img class="w-full" src="https://source.unsplash.com/500x270/?{{ $podcast->category->name }}" alt="your music">
                      <div class="play-btn">
